...
- `env_req`: This folder contains `environment.yml` and `environment_cuda.yml` files denoting the configuration of the virtual environment required to run the modules of this project.
