# Atari Pong with Deep Reinforcement Learning Project Repo
...
- `core`: This folder contains the core components of the deep reinforcement models. It contains a general DQN class and torch models for the `q_network` which sit on top of it. This directory contains the bulk of the code of this repo.
